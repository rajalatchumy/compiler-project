...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INLINE_CODE = 9,                /* INLINE_CODE  */
  YYSYMBOL_BLOCK_CODE = 10,                /* BLOCK_CODE  */
  YYSYMBOL_H1 = 11,                        /* H1  */
  YYSYMBOL_H2 = 12,                        /* H2  */
  YYSYMBOL_H3 = 13,                        /* H3  */
  YYSYMBOL_H4 = 14,                        /* H4  */
  ...
  YYSYMBOL_STR = 20,                       /* STR  */
  YYSYMBOL_SVG_BEGIN = 21,                 /* SVG_BEGIN  */
  YYSYMBOL_SVG_END = 22,                   /* SVG_END  */
  YYSYMBOL_COMMA = 23,                     /* COMMA  */
  YYSYMBOL_LINE = 24,                      /* LINE  */
  YYSYMBOL_POLYLINE = 25,                  /* POLYLINE  */
  YYSYMBOL_CIRCLE = 26,                    /* CIRCLE  */
  YYSYMBOL_ELLIPSE = 27,                   /* ELLIPSE  */
  YYSYMBOL_RECT = 28,                      /* RECT  */
...
static const char *const yytname[] =
{
  ...
  "BLANK_LINE", "BOLD", "ITALIC", "UNDERLINE", "STRIKETHROUGH",
  "INLINE_CODE", "BLOCK_CODE", "H1", "H2", "H3", "H4", "H5", "H6", "HR",
  "QUOTE", "TEXT", "STR", "SVG_BEGIN", "SVG_END", "COMMA", "LINE",
  "POLYLINE", "CIRCLE", "ELLIPSE", "RECT", "NUMBER", "$accept", "text", YY_NULLPTR
};
...
#line 87 "parser.y"
         {
        (yyval.dom_list) = str_copy((yyvsp[0].text));
    }
#line 1254 "y.tab.c"
    break;
